...
void CUser::GetUserInfo(Packet & pkt)
{
	...
	pkt	<< GetLevel() << m_bRace << m_sClass
		...
		<< m_bIsHidingCospre // Cospre Hide/Unhide
 ...
 //pkt << uint16(0) << uint16(0) << uint16(0) << uint8(0) << GetZoneID() << uint8(-1) << uint8(-1) << uint16(0) << uint16(0) << uint8(m_bIsHidingCospre) << uint16(0) << uint16(0) << uint8(0) << uint16(0) << uint16(0) << uint8(0) << uint8(1);
